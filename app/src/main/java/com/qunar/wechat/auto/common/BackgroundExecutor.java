...
public class BackgroundExecutor {
    ...
    private static final int maxWorkCount = 2 * Runtime.getRuntime().availableProcessors()+8;
    public static Executor DEFAULT_EXECUTOR  = new ScheduledThreadPoolExecutor(maxWorkCount
            ,new ThreadFactory() {
        private final AtomicInteger mCount = new AtomicInteger(1);

        public Thread newThread(Runnable r) {
            return new Thread(r, "Qtakl Upload task" + mCount.getAndIncrement());
        }
